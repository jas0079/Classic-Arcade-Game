...
// How the enemy functions
const Enemy = function (x, y, speed) {
    this.x = x;
    this.y = y;
    this.speed = speed;
    this.sprite = 'images/enemyNeighbour.png';
};
...
// How the player functions
const Player = function (x, y) {
    this.x = x;
    this.y = y;
    this.lives = 3;
    this.score = 0;
    this.sprite = 'images/cute-cat.png';
};
...
// How and where the Gems are for extra points
const Gem = function (sprite, value) {
    ...
    this.timeToHide = Math.round(Math.random() * (13 - 5)) + 10;
};
...
// Starting and prepping the game
